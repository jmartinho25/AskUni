    ...
    <div class="question-section">
        <div class="question-item">
            ...
            @auth
                ...
                @can('delete', $question)
                    <form action="{{ route('questions.destroy', $question->posts_id) }}" method="POST" style="display:inline-block;">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this question?')">Delete Question</button>
                    </form>
                @endcan
            ...
            @can('admin', Auth::user())
                <a class="button" href="{{ route('questions.edit-tags', $question->posts_id) }}" id="btn-edit" title="Edit Tags">
